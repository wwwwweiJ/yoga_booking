...
pub struct RegisterParams {
    ...
    pub password: String,
    pub name: String,
    /// The studio this account belongs to. A user is bound to one
    /// organization and cannot cross to another.
...
impl Model {
    ...
    pub async fn create_with_password(
        ...
        let user = users::ActiveModel {
            ...
            organization_id: ActiveValue::set(params.organization_id),
            ..Default::default()
        }
        .insert(&txn)
        .await?;
